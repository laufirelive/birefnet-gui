...
从 [Releases](https://github.com/laufirelive/birefnet-gui/releases) 下载对应平台的文件：

- **macOS**: 下载 `BiRefNet-GUI-macOS-ARM.zip`，解压即可
- **Windows**: 下载所有 `BiRefNet-GUI-Windows.zip.001`、`.002` 等分卷文件，放在同一目录，用 [7-Zip](https://7-zip.org/) 右键解压 `.001` 文件即可
